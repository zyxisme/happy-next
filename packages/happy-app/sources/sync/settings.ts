...
export const AIBackendProfileSchema = z.object({
    ...
    defaultPermissionMode: z.enum(['default', 'acceptEdits', 'auto', 'bypassPermissions', 'plan', 'read-only', 'on-failure', 'full-auto', 'auto_edit', 'yolo']).optional(),
...
export const SettingsSchema = z.object({
    ...
    voiceAssistantSendConfirmation: z.boolean().describe('Whether to show a send-confirmation countdown before the voice assistant sends a message'),
    voiceAssistantSendConfirmationSpeed: z.enum(['fast', 'normal', 'slow']).describe('Countdown speed for the send-confirmation prompt'),
...
export const settingsDefaults: Settings = {
    ...
    voiceAssistantSendConfirmationSpeed: 'normal',
