...
export const pt: TranslationStructure = {
    ...
    openclaw: {
        ...
        sessionTypeGroup: 'Sessão em grupo',
        infoType: 'Tipo',
        infoModel: 'Modelo',
        infoTokens: 'Tokens',
        infoContext: 'Contexto',
        infoUpdated: 'Atualizado',
        infoMachine: 'Máquina',
        infoSessionKey: 'Chave da sessão',
        infoCopied: 'Copiado',
    },
    ...
    message: {
        ...
        stopVoice: 'Parar voz',
        tooLongPlaceholder: ({ chars }: { chars: number }) => `Mensagem longa (${chars} caracteres). Toque para ver.`,
    },
