...
Voice works in multiple languages. The agent performs automatic speech correction for technical terms and programming jargon, which is especially useful for non-English languages where STT may misinterpret code-related terminology.

Supported languages include: English, Chinese, Japanese, Korean, Spanish, French, German, and more.
